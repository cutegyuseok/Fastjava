...
public class dinnerMenu {
    ...
    static int yesterDayMenu = 0;
        ...
        static void mainMenu() throws IOException{
            ...
            JLabel jLabel4 = new JLabel("메뉴를 수정 하시려면 버튼을 눌러주세요");
            ...
            JButton jButton4 = new JButton("메뉴 수정하기");
    ...
    static void deleteMenu(){
        ...
        jd.setBounds(500, 300, 400, 300);
        JLabel[] jLabel = new JLabel[menuNum];
        JButton[] jButton = new JButton[menuNum];
        for(int i=0;i<menuNum;i++) {
            jLabel[i] = new JLabel(menus[i]);
            jButton[i] = new JButton("삭제");
